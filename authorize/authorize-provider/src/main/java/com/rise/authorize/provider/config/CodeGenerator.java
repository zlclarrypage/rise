...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //获取当前项目路径
        //自动生成代码存放的路径
        gc.setOutputDir("/Users/zhanglichang/Documents/CodeGenerator");
        //设置 --作者注释
        gc.setAuthor("张牧之");
        //是否打开文件夹
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/rise_sys?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("com.rise.authorize");
        pc.setEntity("model");
        pc.setMapper("mapper");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return "/Users/zhanglichang/Documents/CodeGenerator/" + pc.getModuleName()
